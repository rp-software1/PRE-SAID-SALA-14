  ...
  return (
    <div className="animate-fade-in">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
        <div>
          <p style={{ margin: "0 0 4px", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--gold)" }}>
      ...
      {showForm && (
        <div className="animate-slide-down" style={{
          ...
          <h3 style={{ margin: "0 0 1.25rem", fontSize: "1rem", fontWeight: 700, color: "var(--text-primary)" }}>
            {editingId ? "✏️ Editar Plato" : "✨ Nuevo Plato"}
          </h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: "12px", alignItems: "end" }}>
              ...
              <div>
                ...
                <input
                  ...
                  required step="0.01" min="0" style={inputStyle}
                />
              </div>
