...
| ✅ R2 | ¿Existe @JoinTable en la relación ManyToMany? | Sí, con tabla intermedia pedido_platos |
...
| ✅ R7 | ¿GET /pedidos retorna pedidos CON mesa y platos cargados (relations)? | Sí, con relations: { mesa: true, platos: true } |
